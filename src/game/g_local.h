...
#define WEBSITE "http://xserverx.com"
...
struct gentity_s
{
  ...
  char 				lastmessage[MAX_STRING_CHARS];
...
typedef struct
{
  ...
  int				wavehumanturn;
  int				wavealienturn;
  int				waveturn; //1 aliens, 2 humans
  int				lol;
...
extern  vmCvar_t  g_globalpath;
extern  vmCvar_t  g_specNoClip;

extern vmCvar_t g_reactorBuildTime;
extern vmCvar_t g_reactorHealRate;
